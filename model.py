...
def save_all_weights(d, g, epoch_number, current_loss):
    ...
    g.save_weights(os.path.join(save_dir, 'generator_{}_{}_{}.h5'.format(epoch_number, current_loss,z)), True)
...
@click.command()
@click.option('--n_images', default=20000, help='Number of images to load for training')
@click.option('--batch_size', default=32, help='Size of batch')
